...
Generated with the factory image deployment (`factory-image`, Azure OpenAI image generation) on 2026-08-28. The resulting image is original to this product and shipped as two responsive WebP sizes plus its lossless source PNG and prompt sidecar in `assets/src/`.

The 1200 × 630 social preview is a hand-composed WebP made on 2026-09-05 from the shipped poster crop, the documented palette, and product text. The 180 × 180 apple-touch icon is a crop of the same original poster. Neither asset introduces a third-party image or font.
